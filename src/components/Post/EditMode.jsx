...
const EditMode = ({ tweet, close }) => {
  ...
  return (
    <>
      ...
      <button
        onClick={handleSave}
        className="mx-5 p-2 text-green-400 border border-zinc-500 rounded-lg shadow hover:bg-zinc-700 transition"
      >
        <BiSolidSave />
      </button>
      <button
        className="mx-5 p-2 text-red-400 border border-zinc-500 rounded-lg shadow hover:bg-zinc-700 transition"
        onClick={close}
      >
        <ImCancelCircle />
      </button>
